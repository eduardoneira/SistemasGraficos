function Tire(delta, M, radius, light){
  ...
  this.loft = new Loft(shape, sweep_path, textures["tire"], 0, basicShaderHandler, light, [0.1, 0.1, 0.1]);
  this.loft.init();

  // rescalo textura:
  for(var i = 1; i < this.loft.texture_buffer.length; i+=2){
    this.loft.texture_buffer[i] *= 4;
   }  
